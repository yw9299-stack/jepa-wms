...
if [ "$TASK" = pusht ]; then
  ...
  PI_RUN="${PI_RUN:-pusht_jepa_wm_pi_ltc_step111464_v5_seed3072}"
  VANILLA_RUN="${VANILLA_RUN:-pusht_jepa_wm_vanilla_step111464_v5_seed3072}"
else
  ...
  PI_RUN="${PI_RUN:-cube_jepa_wm_pi_ltc_step51184_v5_seed3072}"
  VANILLA_RUN="${VANILLA_RUN:-cube_jepa_wm_vanilla_step51184_v5_seed3072}"
fi
